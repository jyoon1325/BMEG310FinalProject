...
#isolate columns: Gene (Hugo_Symbol) and Patient (Tumor_Sample_Barcode)
gene_patient_data <- filtered_mutations[, c("Hugo_Symbol", "Tumor_Sample_Barcode")]

#remove duplicates of Gene and Patient
gene_patient_data <- unique(gene_patient_data)

#binary column (1 = mutation exists)
gene_patient_data$mutated <- 1

#gene-patient matrix 
#genes as rows and patients as columns
