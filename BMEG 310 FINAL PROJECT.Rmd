...
#extract columns: Gene (Hugo_Symbol) and Patient (Tumor_Sample_Barcode)
gene_patient_data <- filtered_mutations[, c("Hugo_Symbol", "Tumor_Sample_Barcode")]

#binary column for the presence of a mutation
gene_patient_data$mutated <- 1

#matrix with genes as rows and patients as columns
...
#Replace NA values with 0 (no mutation)
gene_patient_matrix[is.na(gene_patient_matrix)] <- 0

#clean column names to remove redundant "mutated."
